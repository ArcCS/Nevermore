...
var Spells = map[string]Spell{
 ...
 Cost: 2, 
 Effect: "heal-stam", 
 Classes: map[string]int64{ "cleric": 1, "mage": 1, "paladin": 1, "ranger": 1, "bard": 1, "thief": 1, "barbarian": 1, "fighter": 1, "monk": 1} ,
},
	"mend": { 
 Name: "mend",
 ...
 Cost: 4, 
 Effect: "heal-vit", 
 Classes: map[string]int64{ "cleric": 3, "mage": 4, "paladin": 3, "ranger": 4, "bard": 3, "thief": 4, "barbarian": 6, "fighter": 5, "monk": 5} ,
},
	"heal": { 
 Name: "heal",
 ...
 Cost: 30, 
 Effect: "heal-all", 
 Classes: map[string]int64{ "cleric": 8, "paladin": 12} ,
},
	"detraumatize": { 
 Name: "detraumatize",
 ...
 Cost: 7, 
 Effect: "heal", 
 Classes: map[string]int64{ "cleric": 7, "paladin": 9, "bard": 11} ,
},
	"renewal": { 
 Name: "renewal",
 ...
 Cost: 13, 
 Effect: "heal", 
 Classes: map[string]int64{ "cleric": 11, "paladin": 13, "bard": 16} ,
},
	"hurt": {
 Name: "hurt",
 ...
 Cost: 3, 
 Effect: "air-damage", 
 Classes: map[string]int64{ "cleric": 1, "mage": 1, "paladin": 2, "ranger": 2, "bard": 2, "thief": 4, "barbarian": 7, "fighter": 5, "monk": 3} ,
},
	"rumble": { 
 Name: "rumble",
 ...
 Cost: 7, 
 Effect: "air-damage", 
 Classes: map[string]int64{ "cleric": 6, "mage": 5, "paladin": 7, "ranger": 7, "bard": 7, "thief": 10} ,
},
	"stonecrush": { 
 Name: "stonecrush",
 ...
 Cost: 10, 
 Effect: "air-damage", 
 Classes: map[string]int64{ "cleric": 11, "mage": 9, "paladin": 12, "ranger": 12, "bard": 12} ,
},
	"shatterstone": { 
 Name: "shatterstone",
 ...
 Cost: 15, 
 Effect: "air-damage", 
 Classes: map[string]int64{ "cleric": 15, "mage": 12, "bard": 16} ,
},
	"engulf": { 
 Name: "engulf",
 ...
 Cost: 40, 
 Effect: "air-damage", 
 Classes: map[string]int64{ "mage": 16} ,
},
	"earthquake": { 
 Name: "earthquake",
 ...
 Cost: 75, 
 Effect: "fire-damage", 
 Classes: map[string]int64{ "mage": 21} ,
},
	"acidify": { 
 Name: "acidify",
 ...
 Cost: 100, 
 Effect: "fire-damage", 
 Classes: map[string]int64{ "mage": 25} ,
},
	"disintegrate": { 
 Name: "disintegrate",
 ...
 Cost: 5, 
 Effect: "light", 
 Classes: map[string]int64{ "cleric": 3, "mage": 3, "paladin": 4, "ranger": 4, "bard": 4, "thief": 7, "monk": 5} ,
},
	"curepoison": { 
 Name: "curepoison",
 ...
 Cost: 10, 
 Effect: "bless", 
 Classes: map[string]int64{ "cleric": 5, "paladin": 8, "monk": 10} ,
},
	"protection": { 
 Name: "protection",
 ...
 Cost: 15, 
 Effect: "invisibility", 
 Classes: map[string]int64{ "mage": 10, "bard": 15} ,
},
	"detect-invisible": { 
 ...
 Classes: map[string]int64{ "cleric": 1, "mage": 1, "paladin": 1, "ranger": 1, "bard": 1, "thief": 2, "barbarian": 3, "fighter": 3, "monk": 2} ,
},
	"teleport": { 
 Name: "teleport",
 ...
 Cost: 25, 
 Effect: "enchant", 
 Classes: map[string]int64{ "mage": 3},
},
"word of recall": {
...
Classes: map[string]int64{"cleric": 10, "paladin": 16},
},
	"summon": { 
 Name: "summon",
 ...
 Cost: 50, 
 Effect: "summon", 
 Classes: map[string]int64{ "cleric": 15, "mage": 15, "paladin": 18, "ranger": 18, "bard": 18},
},
	"wizard-walk": { 
 Name: "wizard-walk",
 ...
 Cost: 100, 
 Effect: "wizard-walk", 
 Classes: map[string]int64{ "cleric": 25, "mage": 25, "ranger": 25},
},
	"levitate": { 
 Name: "levitate",
 ...
 Cost: 10, 
 Effect: "levitate", 
 Classes: map[string]int64{ "cleric": 4, "mage": 4, "paladin": 7, "ranger": 7, "bard": 6, "thief": 10, "monk": 8} ,
},
	"resist-fire": { 
 Name: "resist-fire",
 ...
 Cost: 20, 
 Effect: "resist-fire", 
 Classes: map[string]int64{ "cleric": 7, "mage": 7, "paladin": 11, "ranger": 11, "bard": 9, "monk": 13} ,
},
	"resist-magic": { 
 Name: "resist-magic",
 ...
 Cost: 25, 
 Effect: "resist-magic", 
 Classes: map[string]int64{ "cleric": 9, "mage": 8, "paladin": 14, "ranger": 14, "bard": 12} ,
},
	"remove-curse": { 
 Name: "remove-curse",
 ...
 Cost: 18, 
 Effect: "remove-curse", 
 Classes: map[string]int64{ "cleric": 5, "mage": 6, "paladin": 7, "ranger": 9, "bard": 9, "thief": 13, "monk": 10} ,
},
	"resist-air": { 
 Name: "resist-air",
 ...
 Cost: 15, 
 Effect: "clairvoyance", 
 Classes: map[string]int64{ "cleric": 8, "mage": 8, "paladin": 9, "ranger": 9, "bard": 9, "thief": 10, "fighter": 15, "monk": 10} ,
},
	"remove-disease": { 
 Name: "remove-disease",
 ...
 Classes: map[string]int64{ "cleric": 5, "mage": 6, "paladin": 6, "ranger": 7, "bard": 7, "thief": 9, "fighter": 12, "monk": 10} ,
},
	"remove-blindness": { 
 ...
 Classes: map[string]int64{ "cleric": 5, "mage": 6, "paladin": 6, "ranger": 7, "bard": 7} ,
},
	"polymorph": { 
 Name: "polymorph",
 ...
 Cost: 25, 
 Effect: "polymorph", 
 Classes: map[string]int64{ "mage": 10} ,
},
	"attraction": { 
 Name: "attraction",
 ...
 Cost: 15, 
 Effect: "attraction", 
 Classes: map[string]int64{ "mage": 7} ,
},
	"inertial-barrier": { 
 ...
 Classes: map[string]int64{ "mage": 9} ,
},
	"surge": { 
 Name: "surge",
 ...
 Cost: 15, 
 Effect: "surge", 
 Classes: map[string]int64{ "cleric": 9, "mage": 11, "paladin": 13, "ranger": 15, "bard": 14} ,
},
	"resist-poison": { 
 Name: "resist-poison",
 ...
 Classes: map[string]int64{ "cleric": 5, "mage": 6, "paladin": 7, "ranger": 7, "bard": 7, "thief": 8, "fighter": 9, "monk": 7} ,
},
	"resilient-aura": { 
 Name: "resilient-aura",
 ...
 Classes: map[string]int64{ "cleric": 7, "mage": 8, "paladin": 9, "ranger": 9, "bard": 9, "thief": 11} ,
},
	"resist-disease": { 
 Name: "resist-disease",
 ...
 Classes: map[string]int64{ "cleric": 6, "mage": 7, "paladin": 8, "ranger": 8, "bard": 8, "thief": 9, "fighter": 10, "monk": 8} ,
},
	"disrupt-magic": { 
 Name: "disrupt-magic",
 ...
 Classes: map[string]int64{ "mage": 18} ,
},
	"reflection": { 
 Name: "reflection",
 ...
 Cost: 75, 
 Effect: "reflection", 
 Classes: map[string]int64{ "cleric": 25, "mage": 17, "bard": 25} ,
},
	"dodge": { 
 Name: "dodge",
 ...
 Cost: 25, 
 Effect: "dodge", 
 Classes: map[string]int64{ "mage": 19, "ranger": 18, "bard": 22, "thief": 15, "monk": 18} ,
},
	"resist-acid": { 
 Name: "resist-acid",
 ...
 Cost: 25, 
 Effect: "resist-acid", 
 Classes: map[string]int64{ "cleric": 9, "mage": 10, "paladin": 13, "ranger": 13, "bard": 13, "thief": 15, "monk": 11} ,
},
	"embolden": { 
 Name: "embolden",
 ...
 Cost: 5, 
 Effect: "embolden", 
 Classes: map[string]int64{ "cleric": 5, "mage": 6, "paladin": 8, "ranger": 8, "bard": 10, "thief": 12, "fighter": 15, "monk": 9} ,
},
}
