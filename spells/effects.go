...
func earthdamage(caller mobnpcspells, target mobnpcspells, modifier int) string {
	damage := 0
	if modifier == 1 {
		damage = 10
	} else if modifier == 2 {
...
func airdamage(caller mobnpcspells, target mobnpcspells, modifier int) string {
	damage := 0
	if modifier == 1 {
		damage = 10
	} else if modifier == 2 {
...
func waterdamage(caller mobnpcspells, target mobnpcspells, modifier int) string {
	damage := 0
	if modifier == 1 {
		damage = 10
	} else if modifier == 2 {
