...
func (inventory) process(s *state) {
	...
	s.msg.Actor.SendInfo("You are carrying " + strconv.Itoa(s.actor.GetCurrentWeight()) + ", (Inventory: " + strconv.Itoa(len(inv)) + " items at " + strconv.Itoa(s.actor.Inventory.TotalWeight) + "lbs; Equipment: " + strconv.Itoa(s.actor.Equipment.Weight) + "lbs)")
